    ...
    public class Order_datatableController : Controller
    {
        ...
        )
        {
            ...
            var orderdata =
                ...
                join pic in _context.ProductPicturetables on o.PNumber equals pic.PNumber
                join f in _context.FirmPagetables on o.FNumber equals f.FNumber
            ...
            orderdata = from o in orderdata where o.start >= start select o;
            if (end > DateTime.Parse("01-01-1900"))
            {
                orderdata = from o in orderdata where o.start <= end select o;
            }

            if (o_status != "全部")
            {
                orderdata = from o in orderdata where o.ostatus == o_status select o;
            }
            ...
            if (o_type != "全部")
            {
                if (o_type == "直購")
                {
                    orderdata = from o in orderdata where o.otype == false select o;
                }
                else
                {
                    orderdata = from o in orderdata where o.otype == true select o;
                }
            }
            if (ship_status != "全部")
            {
                orderdata = from o in orderdata where o.oshipstatus == ship_status select o;
            }

            if (onumber != null)
            {
                orderdata = from o in orderdata where o.onumber == onumber select o;
            }

            if (fname != null)
            {
                orderdata = from o in orderdata where o.fname == fname select o;
            }

            if (orderby == 1)
            {
                orderdata = from o in orderdata orderby o.start descending select o;
            }
            else if (orderby == 2)
            {
                orderdata = from o in orderdata orderby o.oprice descending select o;
            }
            else
            {
                orderdata = from o in orderdata orderby o.oprice select o;
            }
        ...
        {
            if (
                _context.OrderAssesstables.Where(x => x.ONumber == onumber).FirstOrDefault() == null
            )
            {
                return Content("null");
            }
            ...
            var myassess =
                from o in _context.OrderAssesstables
        ...
        {
            var getpnumber = from o in _context.OrderDatatables where o.ONumber == onumber select o;
        ...
        public IActionResult order_f()
        {
            ...
            var orderdata =
                from o in _context.OrderDatatables
                join pic in _context.ProductPicturetables on o.PNumber equals pic.PNumber
                join c in _context.CustomerAccounttables on o.CNumber equals c.CNumber
                join p in _context.ProductDatatables on o.PNumber equals p.PNumber
                //join s in _context.ShipDatatables
                //on o.OShip equals s.ShipNumber
                //join pay in _context.PaymentDatatables
        ...
        )
        {
            ...
            System
                .Diagnostics
                .Debug
                .WriteLine("my fnumberrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr" + id);
            var orderdata =
                from o in _context.OrderDatatables
                join pic in _context.ProductPicturetables on o.PNumber equals pic.PNumber
                join c in _context.CustomerAccounttables on o.CNumber equals c.CNumber
            ...
            if (cname != null)
            {
                orderdata = from o in orderdata where o.cname == cname select o;
            }
        ...
        public IActionResult getship(int onumber)
        {
            var ship =
                from o in _context.OrderDatatables
                join s in _context.ShipDatatables on o.OShip equals s.ShipNumber
                where o.ONumber == onumber
        ...
        public IActionResult Index2()
        {
            ...
            var membermax =
                from m in _context.MemberMembertables
