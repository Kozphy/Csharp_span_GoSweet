...
public partial class ShopwebContext : DbContext
{
    ...
    public virtual DbSet<ProductGroupView> ProductGroupViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderDatatable>(entity =>
        {
            ...
            entity.HasOne(d => d.FNumberNavigation).WithMany(p => p.OrderDatatables)
                .HasForeignKey(d => d.FNumber)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Order_datatable_Firm_accounttable");

            entity.HasOne(d => d.MNumberNavigation).WithMany(p => p.OrderDatatables)
        ...
        modelBuilder.Entity<ProductGroupView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ProductGroupView");
